...
int main(void)
{
    ...
    Camera3D camera = { 0 };
    camera.position = (Vector3){ -7,1,0 };  // Camera position
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        Vector3 startPos = {30,0,0};
        Vector3 endPos = {30,0.9,0};
        Vector2 size = {50,100};
        Vector3 startPos2 = {30,0,2};
        Vector3 endPos2 = {30,0.9,2};
        ...
        BeginDrawing();
            ...
            //start
             ...
             DrawText(TextFormat("Y %f",y), 10, 10, 20, MAROON);
             DrawText(TextFormat("X %f",x), 10, 30, 20, MAROON);
          
           DrawText(TextFormat("Z %f",z), 10, 50, 20, MAROON);
            DrawText(TextFormat("targetZ %i", GetMouseX()), 300, 50, 20, MAROON);
